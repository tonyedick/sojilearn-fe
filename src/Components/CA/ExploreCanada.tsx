                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-1">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={capital} className="img-fluid" alt="Sojilearn explore canada"/></Link>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-2">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={population} className="img-fluid" alt="Sojilearn explore canada population"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-3">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={language} className="img-fluid" alt="Sojilearn canada language of communication"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-4">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={students} className="img-fluid" alt="Sojilearn explore canada international students"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-10">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={gdp} className="img-fluid"  alt="Sojilearn explore canada gdp"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-6">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={dialing} className="img-fluid" alt="Sojilearn explore canada dialing code"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="edu_cat_2 cat-8">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={currency} className="img-fluid"  alt="Sojilearn explore canada currency"/></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="edu_cat_2 cat-9">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" to="/"><img src={students} className="img-fluid"  alt="Sojilearn explore canada universities and colleges"/></Link>
                            </div>
                            <div className="edu_cat_data">
