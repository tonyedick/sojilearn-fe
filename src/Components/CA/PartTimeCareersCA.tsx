                    ...
                    <div className="mb-4 mt-4 ml-lg-0 mr-lg-4">
                        <div className="row mt-3">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={arts} height="50" width="50" className="img-fluid"  alt="Canada courses arts and humanities"/>
                                    </div>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={socialsciences} height="50" width="50" className="img-fluid" alt="Canada courses social sciences"/>
                                    </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={law} height="50" width="50" className="img-fluid" alt="Canada courses law and legal studies"/>
                                    </div>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={engineering} height="50" width="50" className="img-fluid" alt="Canada courses engineering and technology"/>
                                    </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={architecture} height="50" width="50" className="img-fluid" alt="Canada courses architecture"/>
                                    </div>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={design} height="50" width="50" className="img-fluid" alt="Canada courses design"/>
                                    </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={medicine} height="50" width="50" className="img-fluid"  alt="Canada courses medicine and life sciences"/>
                                    </div>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <img src={naturalsciences} height="50" width="50" className="img-fluid"  alt="Canada courses natural sciences"/>
                                    </div>
